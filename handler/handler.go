...
type Handler interface {
	...
	GetUserAverageActiveMeasurement(ctx context.Context, req *go_block.UserRequest) (*go_block.UserResponse, error)
	GetNamespaceAverageActiveMeasurement(ctx context.Context, req *go_block.UserRequest) (*go_block.UserResponse, error)
